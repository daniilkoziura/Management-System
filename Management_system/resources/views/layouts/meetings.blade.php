    ...
    <div class="container">
        ...
        <div id="user-status-block">
            <form method="POST" action="/manager/meeting/{{$user->id}}/choice">
                ...
                <button class="b-risk" value="0" name="risk"><img src="/images/0.png" width="25" height="25" alt="risk">
                </button>
                <button class=" b-risk" value="1" name="risk"><img src="/images/1.png" width="25" height="25"
                                                                   alt="risk"></button>
                <button class=" b-risk" value="2" name="risk"><img src="/images/2.png" width="25" height="25"
                                                                   alt="risk"></button>
            </form>
        </div>
        <div class="list-group-item clearfix">
            ...
            <span class="user-email risk-middle"><span class="click-for-show"
                                                       onclick="showThat()">Select risk-status</span></span>
            ...
            <div>
                <table class="table table-responsive  table-hover">
                    ...
                    @foreach ($meetings as $meeting)
                        <tr>
                            <th class="text-table"><a
                                        href="/meeting/{{$user->id}}/{{$meeting->id}}">{{$meeting->title}}</a></th>
