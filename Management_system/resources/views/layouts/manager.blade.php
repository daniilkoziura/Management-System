            ...
            <div class="list-group add-hidden-border list-group-upgrade-lg">
                ...
                <div class="list-group-item">
                    ...
                    <table class="table table-responsive  table-hover">
                        ...
                        <tr>
                            <th scope="row"><a href="/meeting/{{$user->id}}"><img src="/images/{{$user->risk_status}}.png" width="25" height="25" alt=""></a></th>
            ...
            <div class="recommended row row-upgraded-md ">
                    ...
                    <div class="list-group-item">
                        ...
                        @foreach($recommended as $key=>$users)
                           @if($key <=9)
                            <tr>
                                <th scope="row"><a href="/meeting/{{$users['id']}}"><img src="/images/{{$users['risk_status']}}.png" width="25" height="25" alt=""></a></th>
